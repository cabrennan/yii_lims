...
/**
 * This is the model class for table "sample_db.tech_type".
 *
 * The followings are the available columns in table 'sample_db.tech_type':
 ...
 */
class TechType extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'solexaSamples' => array(self::HAS_MANY, 'SolexaSample', 'tech_type'),
		);
	}
	 ...
	 * @return TechType the static model class
	 */
