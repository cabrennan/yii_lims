...
/**
 * This is the model class for table "sample_db.source_type".
 *
 * The followings are the available columns in table 'sample_db.source_type':
...
class SourceType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'solexaSamples' => array(self::HAS_MANY, 'SolexaSample', 'new_src_type'),
		);
	}
