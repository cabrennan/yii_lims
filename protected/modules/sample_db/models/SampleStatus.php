...
/**
 * This is the model class for table "sample_db.sample_status".
 *
 * The followings are the available columns in table 'sample_db.sample_status':
 ...
 */
class SampleStatus extends CActiveRecord
{
	/**
	...
	{
		return 'sample_db.sample_status';
	}
	...
	public function relations()
	{
		...
		return array(
			'solexaSamples' => array(self::HAS_MANY, 'SolexaSample', 'sample_status'),
		);
	}
	 ...
	 * @return SampleStatus the static model class
	 */
