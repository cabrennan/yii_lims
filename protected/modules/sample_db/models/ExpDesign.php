...
/**
 * This is the model class for table "sample_db.exp_design".
 *
 * The followings are the available columns in table 'sample_db.exp_design':
 ...
 */
class ExpDesign extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'solexaSamples' => array(self::HAS_MANY, 'SolexaSample', 'exp_design'),
		);
	}
	 ...
	 * @return ExpDesign the static model class
	 */
