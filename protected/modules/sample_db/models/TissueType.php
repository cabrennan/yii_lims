...
/**
 * This is the model class for table "sample_db.tissue_type".
 *
 * The followings are the available columns in table 'sample_db.tissue_type':
 ...
 */
class TissueType extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'solexaSamples' => array(self::HAS_MANY, 'SolexaSample', 'tissue_type'),
		);
	}
	 ...
	 * @return TissueType the static model class
	 */
