...
class SampleController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('update', 'admin', 'archivesample'),
    ...
    public function actionArchiveSample($sample_id, $iso_batch_id) {
        $model = $this->loadModel($sample_id);
        // Move this sample to 'Archive' then return user to isolate batch creation
        $sql = 'UPDATE sample set status = "Archived" where sample_id = ' . $sample_id;
        Yii::app()->db->createCommand($sql)->execute();
        $this->redirect(array('/lab/isoBatch/edit', 'id' => $iso_batch_id));
    }
